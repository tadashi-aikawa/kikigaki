...
文字サイズは現行本文15ptを基準とする初期案。段3の狭幅・広幅の実画面レビューで調整する。

| 要素 | 描き方 |
|---|---|
| 本文 | 15pt、`Washi.ink`、行間4pt、段落間に余白 |
| h1〜h6 | `ink`・semibold。h1は18pt、h2は17pt、h3は16pt、h4以降は15pt。行の中の返事として控えめにし、最終値は段3でクロディーヌが確認 |
...
| 太字・斜体・取り消し | `ink` semibold・斜体・取り消し線。併用時に片方を落とさない |
